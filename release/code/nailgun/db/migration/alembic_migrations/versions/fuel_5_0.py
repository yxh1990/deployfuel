...
def upgrade():
    ...
    op.create_table('releases',
                    ...
                    sa.Column('roles_metadata', JSON(), nullable=True),
                     sa.Column(
                        'profilename', sa.String(length=20),
                        nullable=True),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('nodes',
                    ...
                    sa.Column('power_ip', sa.String(length=15), nullable=True),
                    ...
                    sa.Column('user_set',JSON(),nullable=True),
                    sa.Column(
    ...
    op.create_table('tasks',
                    ...
                    sa.Column('node_ids', sa.Text(), nullable=True),
    ...
    op.create_table('neutron_config',
                    ...
                    sa.Column('basic_net', sa.Text(), nullable=True),
    ...
    op.create_table('physical_machine_info',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('name', sa.Unicode(length=50), nullable=False),
    ...
    op.create_table('cluster_setting_info',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('cluster_id', sa.Integer(), nullable=False),
                    sa.Column('cluster_setting', sa.Text(), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('cluster_deploy_msg',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('cluster_id', sa.Integer(), nullable=False),
                    sa.Column('cluster_deploymsg', sa.Text(), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('cluster_role_status',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('cluster_id', sa.Integer(), nullable=False),
                    sa.Column('cluster_role', sa.String(20), nullable=False),
                    sa.Column('role_status', sa.Integer(), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
